.nrdb-debug-view{margin:12px;max-width:1200px}.nrdb-debug-view h1{display:flex;flex-direction:row;align-items:center;justify-content:space-between}.nrdb-debug-description{font-size:.85rem;padding:16px}.debug-filters{display:flex;flex-direction:row;align-items:center;justify-content:flex-start;margin:16px}.debug-filters label{margin-right:1rem}.debug-filters-chips{display:flex;gap:8px;align-items:center}.nested-table,.nested-table .v-table{background-color:#eee}[data-v-0ea52d1d] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px);--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}[data-v-0ea52d1d] .v-input--horizontal{grid-template-areas:"prepend control append";grid-template-rows:auto}.nr-db-layout-group--grid[data-v-0ea52d1d]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;padding:var(--layout-gap);gap:var(--layout-gap)}.nrdb-layout--flex[data-v-0ea52d1d]{--layout-card-width: 320px;--layout-gap: 12px}.nrdb-layout--flex[data-v-0ea52d1d]{display:flex;flex-wrap:wrap;padding:var(--layout-gap);gap:var(--layout-gap)}.nrdb-layout--flex>div[data-v-0ea52d1d]{width:var(--layout-card-width);max-width:100%}.v-card[data-v-0ea52d1d]{width:100%}[data-v-b403de30] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px);--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}[data-v-b403de30] .v-input--horizontal{grid-template-areas:"prepend control append";grid-template-rows:auto}.nr-db-layout-group--grid[data-v-b403de30]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;padding:var(--layout-gap);gap:var(--layout-gap)}.nrdb-layout--grid[data-v-b403de30]{--layout-card-width: 320px;--layout-gap: 12px;--widget-row-height: 48px}.nrdb-layout--grid[data-v-b403de30]{display:grid;grid-template-columns:repeat(12,1fr);flex-wrap:wrap;padding:var(--layout-gap);gap:var(--layout-gap)}.nrdb-layout--grid>div[data-v-b403de30]{width:100%}.v-card[data-v-b403de30]{width:100%}@media only screen and (max-width: 1024px){.nrdb-layout--grid[data-v-b403de30]{grid-template-columns:repeat(9,1fr)}}@media only screen and (max-width: 768px){.nrdb-layout--grid[data-v-b403de30]{grid-template-columns:repeat(6,1fr)}}[data-v-2376fca5] .v-field__input{--v-field-input-min-height: calc(var(--widget-row-height) - 4px);--v-field-input-padding-top: 12px;--v-field-input-padding-bottom: 12px}[data-v-2376fca5] .v-input--horizontal{grid-template-areas:"prepend control append";grid-template-rows:auto}.nr-db-layout-group--grid[data-v-2376fca5]{grid-auto-rows:minmax(var(--widget-row-height),auto);padding:0;grid-template-columns:repeat(6,1fr);display:grid;flex-wrap:wrap;padding:var(--layout-gap);gap:var(--layout-gap)}.nrdb-layout--notebook[data-v-2376fca5]{--layout-card-width: 1024px;--layout-gap: 12px}.nrdb-layout--notebook[data-v-2376fca5]{margin:auto;width:100%;max-width:var(--layout-card-width);min-height:100%;flex-wrap:wrap;padding:var(--layout-gap)}.nrdb-layout--notebook>div[data-v-2376fca5]{width:100%;margin-bottom:var(--layout-gap)}.v-card[data-v-2376fca5]{width:100%}/*!
  Theme: Default
